...
public class JSONHandler {
    ...
    public String[] locateProduct(int sku) throws IOException {
        ...
        JSONObject loc = (JSONObject) ((JSONArray) product.get("locations")).get(0);
        String aisleSide = (String) loc.get("aisleSide");
        String aisle = (String) loc.get("name");
        String shelf = (String) loc.get("shelfNumber");
        return new String[]{aisle, aisleSide, shelf};
    }
}
